...
class DiffusionTrainer(Trainer):
    ...
    def evaluate(
        ...
        # Save the results
        self.save_metrics('generated' + "_" + metric_key_prefix, output.results)
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    # Avoid unnecessary DDP sync`1hronization since there will be no backward pass on this example.
                    with model.no_sync():
