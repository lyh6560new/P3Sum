...
class DiffusionArguments:
    ...
    num_inference_diffusion_steps: int = field(
        default=1000, metadata={"help": "Number of inference diffusion steps."}
    )
    ...
    if_control: bool = field(
        default=False,
        metadata={
            "help": "If set, controls the generation with a control model."
            "This is used for the control experiments."
        },
    )
...
class ControlArguments:
    #when control with FactKB, the first model should better be FactKB
    ctr_model_name: Optional[str] = field(
        default="/home2/yhliu/controlpoli/ssd-lm/FactKB",
        metadata={
            "help": "Define the name of the model to be used for controlling."
        },  
    )
    ctr_model_name2: Optional[str] = field(
        default=None,
        metadata={
            "help": "Define the name of the model to be used for controlling."
        },
    )
    decode_ctr_lr: Optional[float] = field(
        default=2000,
        metadata={
            "help": "Define the learning rate for the decoder of the control model."
        },
    )
    decode_ctr_lr2: Optional[float] = field(
        default=2000,
        metadata={
            "help": "Define the learning rate for the decoder of the control model."
        },
    )
    ctr_opt_label_idx: Optional[int] = field(
        default=1,
        metadata={
            "help": "FACTUALITY: Define the index of the label to optimize for."
        },
    )
    ctr_opt_label_idx2: Optional[int] = field(
        default=0,
        metadata={
            "help": "POLTICICAL BIAS:Define the index of the label to optimize for."
        },
    )
    ctr_model: Optional[str] = field(
        default=None,
        metadata={
            "help": "Define the model to be used for controlling."
        },
    )
    ctr_model2: Optional[str] = field(
        default=None,
        metadata={
            "help": "Define the model to be used for controlling."
        },
    ...
    vocab_size: Optional[int] = field(
        default=50265,
        metadata={
            "help": "Define the vocab size of the control model."
        },
